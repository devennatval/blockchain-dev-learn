...
describe('Exchange', () => {
	...
	beforeEach(async () => {
		...
		token1 = await Token.deploy('Denava', 'DNV', 100000);
		token2 = await Token.deploy('Mock Dai', 'mDAI', 100000);
